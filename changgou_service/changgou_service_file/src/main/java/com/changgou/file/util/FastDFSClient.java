...
public class FastDFSClient {
    ...
    public static void main(String[] args) throws Exception {
        FileInfo fileInfo = getFile("group1","M00/00/00/CiFIYF6C_YqAGR-BAAEeNwJRGZA332.jpg");
        System.out.println(fileInfo.getFileSize());
        System.out.println(fileInfo.getSourceIpAddr());

        InputStream is = downFile("group1","M00/00/00/CiFIYF6C_YqAGR-BAAEeNwJRGZA332.jpg");
        File file;
        ...
        deleteFile("group1", "M00/00/00/CiFIYF6C_YqAGR-BAAEeNwJRGZA332.jpg");
        ...
        // 可能存在多个机器上
        ServerInfo[] fetchStorages = getFetchStorages("group1", "M00/00/00/CiFIYF6C_YqAGR-BAAEeNwJRGZA332.jpg");
        for(ServerInfo group:fetchStorages){
